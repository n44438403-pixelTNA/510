        ...
        <div className="min-h-screen bg-slate-50 pb-20 animate-in fade-in">
            ...
            <div className="p-4 mt-2 max-w-4xl mx-auto">
                ...
                <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 mb-6 flex items-center justify-between">
                    <div>
                        <p className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-1">Access Status</p>
                        <div className="flex items-center gap-2">
                            {isActive ? (
                    ...
                    <div className="text-right">
                        <p className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-1">Valid Until</p>
                ...
                {plans.filter(p => p.isActive).length === 0 ? (
                    <div className="bg-slate-100 p-8 rounded-2xl text-center text-slate-500 border border-slate-200 border-dashed">
