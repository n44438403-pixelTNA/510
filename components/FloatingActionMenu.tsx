                        ...
                        <div className="flex flex-col max-h-[60vh] overflow-y-auto">
                            ...
                            <div className="grid grid-cols-4 gap-2 mb-4 shrink-0">
                                ...
                                {['PDF', 'MCQ', 'ANALYTICS'].includes(activeTab || '') ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center gap-1 p-2 rounded-xl bg-slate-50 text-slate-400 font-bold text-[10px] opacity-50 cursor-not-allowed">
                                        <Globe size={18} /> Translate
                                    </div>
                                )}
                            </div>
