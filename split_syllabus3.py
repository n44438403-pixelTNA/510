...
# Class 8 CBSE & BSEB (Since they use the same English lists in the file)
...
bseb_6_ss = cbse_6_ss.replace('CBSE', 'BSEB')

replacements['"CBSE-6-Social Science": ['] = cbse_6_ss + '\n  "CBSE-6-Social Science": ['
replacements['"BSEB-6-Social Science": ['] = bseb_6_ss + '\n  "BSEB-6-Social Science": ['


for old, new in replacements.items():
    content = content.replace(old, new)

with open('utils/full_syllabus_data_new2.ts', 'w', encoding='utf-8') as f:
    f.write(content)
