...
async def verify():
    async with async_playwright() as p:
        ...
        time.sleep(10) # give vite more time
        ...
        for _ in range(5):
            ...
            try:
                ...
                pass
            try:
                await page.click("button:has-text('I Agree & Continue')", timeout=1000)
                time.sleep(1)
            except:
                pass
            try:
                await page.click("button:has-text('Start Fresh')", timeout=1000)
                time.sleep(1)
            except:
                pass
